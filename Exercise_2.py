...
class retired():
    ...
    def setup():
        ...
        par.h = 1 #starter med at sætte den lig 0, men ændrer den senere til np.array([0, 0.5, 1])
        ...
        par.num_shocks = 5 # denne her variabel er lidt ligemeget, men generalt betyder det at jo flere nodes der kommer jo længere tid tager det, og jo mere præcis bliver det
